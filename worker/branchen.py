...
KARTEN_ZIELGRUPPEN = {
    ...
    # Welle 24 (13.09.2026, 14:30): 27 weitere Solo-Gruppen — Katalog war komplett abgefahren
    'fotobox': ('Fotobox-Vermieter', r"fotobox|photobooth|photo\s?booth|spiegelbox|360", r"gmbh|kg\b"),
    'zauberer': ('Zauberer', r"zauber|magier|magic|illusion|mentalist", r"gmbh|zauberladen|shop"),
    'eventmoderator': ('Eventmoderator', r"moderat|sprecher|conf[eé]rencier|gastgeber", r"gmbh|agentur|radio|\btv\b"),
    'lichttechniker': ('Lichttechniker', r"licht|veranstaltungstechnik|eventtechnik|bühnentechnik|buehnentechnik", r"gmbh|kg\b|ag\b|verleih\s?gmbh"),
    'messebauer': ('Messebauer', r"messebau|messestand|ausstellungsbau|standbau", r"gmbh|kg\b|ag\b"),
    'textildruck': ('Textildrucker', r"textildruck|stickerei|siebdruck|t-?shirt|flock|folienplott", r"gmbh|kg\b|spreadshirt|kette"),
    'steinmetz': ('Steinmetz', r"steinmetz|grabmal|naturstein|bildhauer|steinbildhauer", r"gmbh|kg\b|friedhof|stadt"),
    'autolackierer': ('Lackierer', r"lackier|autolack|karosserie|smart\s?repair", r"gmbh|kg\b|autohaus|kette|identica"),
    'rohrreinigung': ('Rohrreiniger', r"rohrreinig|kanalreinig|abfluss|rohrfrei|kanal", r"gmbh|kg\b|ag\b|kette|franchise|rohrmax|abfluss-?as"),
    'klimatechniker': ('Klimatechniker', r"klima|kälte|kaelte|lüftung|lueftung|wärmepumpe|waermepumpe", r"gmbh|kg\b|ag\b|daikin|viessmann"),
    'rollladenbauer': ('Rollladenbauer', r"roll?laden|jalousie|markise|sonnenschutz|raffstore", r"gmbh|kg\b|warema|kette"),
    'zaunbauer': ('Zaunbauer', r"zaun|zäune|zaeune|sichtschutz|tore?\b", r"gmbh|kg\b|zaunhandel|hornbach|obi|bauhaus"),
    'poolbauer': ('Poolbauer', r"pool|schwimmbad|schwimmteich|whirlpool|sauna", r"gmbh|kg\b|ag\b|desjoyaux|kette"),
    'winterdienst': ('Winterdienst', r"winterdienst|räum|raeum|streu|grünpflege|gruenpflege|gartenpflege", r"gmbh|kg\b|ag\b|stadt|kommunal|dussmann"),
    'abschleppdienst': ('Abschleppdienst', r"abschlepp|pannen|bergung|autotransport|fahrzeugtransport", r"gmbh|kg\b|adac|ag\b|kette"),
    'taxiunternehmer': ('Taxiunternehmer', r"taxi|mietwagen|fahrdienst|krankenfahrt|flughafentransfer", r"gmbh|kg\b|zentrale|genossenschaft|uber|freenow|sixt|europcar"),
    'wassersportlehrer': ('Wassersportlehrer', r"segel|surf|kite|\bsup\b|stand\s?up|kanu|wakeboard|wasserski", r"gmbh|verein|e\.\s?v\.|club|yachtclub"),
    'skilehrer': ('Skilehrer', r"\bski|snowboard|schnee|langlauf", r"gmbh|verein|e\.\s?v\.|bergbahn|ag\b|dsv"),
    'sprecher': ('Synchronsprecher', r"sprecher|voice|stimme|hörbuch|hoerbuch|synchron", r"gmbh|agentur\s?gmbh|studio\s?gmbh|ard|zdf"),
    'lektor': ('Lektor', r"lektor|korrektor|lektorat|korrektorat", r"gmbh|verlag\s?gmbh|ag\b"),
    'sattler': ('Sattler', r"sattler|sattlerei|lederwerkstatt|reitsport|autosattler", r"gmbh|kg\b|krämer|kraemer|loesdau"),
    'achtsamkeitstrainer': ('Achtsamkeitstrainer', r"achtsam|meditation|mbsr|entspann|stressbewält|stressbewaelt", r"gmbh|verein|vhs|krankenkasse|klinik"),
    'rhetoriktrainer': ('Rhetoriktrainer', r"rhetorik|kommunikationstrain|präsentationstrain|praesentationstrain|redetrain", r"gmbh|akademie|institut|ihk"),
    'kartenleger': ('Kartenleger', r"kartenleg|tarot|hellse|medium|lenormand|wahrsag", r"gmbh|hotline|0900|astro\s?tv|questico"),
    'kaffeeroester': ('Kaffeeröster', r"röst|roest|kaffee|coffee", r"gmbh|kg\b|tchibo|kette|starbucks|dallmayr|melitta"),
    'konditor': ('Konditor', r"konditor|torten|patisserie|cake|pralinen|chocolat", r"gmbh|kg\b|kette|bäckerei\s?gmbh|baeckerei\s?gmbh|junge|kamps"),
    'instrumentenbauer': ('Instrumentenbauer', r"geigen|gitarren|klavier|instrumentenbau|klavierstimm|orgelbau|blasinstrument", r"gmbh|musikhaus|thomann|kette"),
}

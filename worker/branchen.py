...
KARTEN_ZIELGRUPPEN = {
    ...
    # Welle 27 (13.09.2026, Justin: „Fokus auf Familie und Geburt"): zweite Begriffsrunde
    # über alle 294 Städte — andere Suchbegriffe liefern auf der Karte andere Treffer.
    "hebamme_kurz":        ("Hebamme", r"hebamme|geburt|wochenbett|rückbildung|r[üu]ckbildung", r"gmbh|\bug\b|klinik|krankenhaus|familienzentrum|familienbildung|elternschule|volkshochschule|\bvhs\b|caritas|diakonie|\bawo\b|\bdrk\b|johanniter|malteser|pro\s?familia|kirche|pfarr|verein|e\.\s?v\.|stadt|landkreis"),
    "geburtsvorbereitung": ("Hebamme", r"hebamme|geburt|schwanger|kurs", r"gmbh|\bug\b|klinik|krankenhaus|familienzentrum|familienbildung|elternschule|volkshochschule|\bvhs\b|caritas|diakonie|\bawo\b|\bdrk\b|johanniter|malteser|pro\s?familia|kirche|pfarr|verein|e\.\s?v\.|stadt|landkreis"),
    "rueckbildung":        ("Hebamme", r"hebamme|r[üu]ckbildung|beckenboden|geburt|schwanger", r"gmbh|\bug\b|klinik|krankenhaus|familienzentrum|familienbildung|elternschule|volkshochschule|\bvhs\b|caritas|diakonie|\bawo\b|\bdrk\b|johanniter|malteser|pro\s?familia|kirche|pfarr|verein|e\.\s?v\.|stadt|landkreis"),
    "familienhebamme":     ("Hebamme", r"hebamme|familie|geburt|wochenbett", r"gmbh|\bug\b|klinik|krankenhaus|familienzentrum|familienbildung|elternschule|volkshochschule|\bvhs\b|caritas|diakonie|\bawo\b|\bdrk\b|johanniter|malteser|pro\s?familia|kirche|pfarr|verein|e\.\s?v\.|stadt|landkreis"),
    "doula_kurz":          ("Doula", r"doula|geburtsbegleit|geburt", r"gmbh|\bug\b|klinik|krankenhaus|familienzentrum|familienbildung|elternschule|volkshochschule|\bvhs\b|caritas|diakonie|\bawo\b|\bdrk\b|johanniter|malteser|pro\s?familia|kirche|pfarr|verein|e\.\s?v\.|stadt|landkreis"),
    "stillberatung":       ("Stillberaterin", r"still|laktation|ibclc|beratung", r"gmbh|\bug\b|klinik|krankenhaus|familienzentrum|familienbildung|elternschule|volkshochschule|\bvhs\b|caritas|diakonie|\bawo\b|\bdrk\b|johanniter|malteser|pro\s?familia|kirche|pfarr|verein|e\.\s?v\.|stadt|landkreis"),
    "beikost":             ("Stillberaterin", r"beikost|ern[äa]hrung|still|baby|beratung", r"gmbh|\bug\b|klinik|krankenhaus|familienzentrum|familienbildung|elternschule|volkshochschule|\bvhs\b|caritas|diakonie|\bawo\b|\bdrk\b|johanniter|malteser|pro\s?familia|kirche|pfarr|verein|e\.\s?v\.|stadt|landkreis|hipp|krankenkasse"),
    "trageberatung_kurz":  ("Trageberaterin", r"trage|tragen|baby|beratung", r"gmbh|\bug\b|klinik|krankenhaus|familienzentrum|familienbildung|elternschule|volkshochschule|\bvhs\b|caritas|diakonie|\bawo\b|\bdrk\b|johanniter|malteser|pro\s?familia|kirche|pfarr|verein|e\.\s?v\.|stadt|landkreis"),
    "babymassage_kurs":    ("Babymassage-Kursleiterin", r"baby|massage|kurs|eltern|kind", r"gmbh|\bug\b|klinik|krankenhaus|familienzentrum|familienbildung|elternschule|volkshochschule|\bvhs\b|caritas|diakonie|\bawo\b|\bdrk\b|johanniter|malteser|pro\s?familia|kirche|pfarr|verein|e\.\s?v\.|stadt|landkreis"),
    "pekip":               ("Eltern-Kind-Kursleiterin", r"pekip|eltern|kind|baby|kurs|spiel|delfi|fabel", r"gmbh|\bug\b|klinik|krankenhaus|familienzentrum|familienbildung|elternschule|volkshochschule|\bvhs\b|caritas|diakonie|\bawo\b|\bdrk\b|johanniter|malteser|pro\s?familia|kirche|pfarr|verein|e\.\s?v\.|stadt|landkreis"),
    "babyschwimmen":       ("Eltern-Kind-Kursleiterin", r"baby|schwimm|wasser|kind|kurs", r"gmbh|\bug\b|klinik|krankenhaus|familienzentrum|familienbildung|elternschule|volkshochschule|\bvhs\b|caritas|diakonie|\bawo\b|\bdrk\b|johanniter|malteser|pro\s?familia|kirche|pfarr|verein|e\.\s?v\.|stadt|landkreis|stadtwerke|bäder|schwimmbad|therme|dlrg|hallenbad|freibad"),
    "musikgarten":         ("Eltern-Kind-Kursleiterin", r"musik|garten|kind|eltern|baby|kurs", r"gmbh|\bug\b|klinik|krankenhaus|familienzentrum|familienbildung|elternschule|volkshochschule|\bvhs\b|caritas|diakonie|\bawo\b|\bdrk\b|johanniter|malteser|pro\s?familia|kirche|pfarr|verein|e\.\s?v\.|stadt|landkreis|musikschule\s+(der\s+)?stadt|städtische|kreismusikschule"),
    "schwangerenyoga":     ("Eltern-Kind-Kursleiterin", r"yoga|schwanger|prenatal|mama|geburt", r"gmbh|\bug\b|klinik|krankenhaus|familienzentrum|familienbildung|elternschule|volkshochschule|\bvhs\b|caritas|diakonie|\bawo\b|\bdrk\b|johanniter|malteser|pro\s?familia|kirche|pfarr|verein|e\.\s?v\.|stadt|landkreis|fitness|mcfit|clever\s?fit"),
    "kinderyoga":          ("Eltern-Kind-Kursleiterin", r"yoga|kind|kids|familie", r"gmbh|\bug\b|klinik|krankenhaus|familienzentrum|familienbildung|elternschule|volkshochschule|\bvhs\b|caritas|diakonie|\bawo\b|\bdrk\b|johanniter|malteser|pro\s?familia|kirche|pfarr|verein|e\.\s?v\.|stadt|landkreis|fitness|schule\b"),
    "babyschlaf":          ("Babyschlaf-Beraterin", r"schlaf|baby|kind|coach|berat", r"gmbh|\bug\b|klinik|krankenhaus|familienzentrum|familienbildung|elternschule|volkshochschule|\bvhs\b|caritas|diakonie|\bawo\b|\bdrk\b|johanniter|malteser|pro\s?familia|kirche|pfarr|verein|e\.\s?v\.|stadt|landkreis"),
    "muetterpflege":       ("Mütterpflegerin", r"mütterpfleg|muetterpfleg|wochenbett|haushaltshilfe|familienpfleg|mütter", r"gmbh|\bug\b|klinik|krankenhaus|familienzentrum|familienbildung|elternschule|volkshochschule|\bvhs\b|caritas|diakonie|\bawo\b|\bdrk\b|johanniter|malteser|pro\s?familia|kirche|pfarr|verein|e\.\s?v\.|stadt|landkreis|sozialstation|pflegedienst"),
    "babybauch_foto":      ("Familienfotograf", r"foto|newborn|baby|bauch|familie|kinder|schwanger", r"gmbh|\bug\b|klinik|krankenhaus|familienzentrum|familienbildung|elternschule|volkshochschule|\bvhs\b|caritas|diakonie|\bawo\b|\bdrk\b|johanniter|malteser|pro\s?familia|kirche|pfarr|verein|e\.\s?v\.|stadt|landkreis|cewe|pixum|picture\s?people|studioline|\bdm\b|rossmann"),
    "familienfotograf":    ("Familienfotograf", r"foto|familie|kinder|newborn|baby", r"gmbh|\bug\b|klinik|krankenhaus|familienzentrum|familienbildung|elternschule|volkshochschule|\bvhs\b|caritas|diakonie|\bawo\b|\bdrk\b|johanniter|malteser|pro\s?familia|kirche|pfarr|verein|e\.\s?v\.|stadt|landkreis|cewe|pixum|picture\s?people|studioline|\bdm\b|rossmann"),
    "kinderwunsch_coach":  ("Kinderwunsch-Beraterin", r"kinderwunsch|fertilit|coach|berat|begleit", r"gmbh|\bug\b|klinik|krankenhaus|familienzentrum|familienbildung|elternschule|volkshochschule|\bvhs\b|caritas|diakonie|\bawo\b|\bdrk\b|johanniter|malteser|pro\s?familia|kirche|pfarr|verein|e\.\s?v\.|stadt|landkreis|zentrum|praxis\s?gmbh|mvz|ivf"),
    "elternberatung":      ("Elternberaterin", r"eltern|erzieh|familie|berat|coach|kind", r"gmbh|\bug\b|klinik|krankenhaus|familienzentrum|familienbildung|elternschule|volkshochschule|\bvhs\b|caritas|diakonie|\bawo\b|\bdrk\b|johanniter|malteser|pro\s?familia|kirche|pfarr|verein|e\.\s?v\.|stadt|landkreis|jugendamt|erziehungsberatungsstelle|beratungsstelle"),
    "tagesmutter_kurz":    ("Tagesmutter", r"tagesmutter|tagesvater|tagespflege|tageskind|tagesmama|kinderbetreu", r"gmbh|\bug\b|klinik|krankenhaus|familienzentrum|familienbildung|elternschule|volkshochschule|\bvhs\b|caritas|diakonie|\bawo\b|\bdrk\b|johanniter|malteser|pro\s?familia|kirche|pfarr|verein|e\.\s?v\.|stadt|landkreis|kita|kindergarten|krippe|hort|ggmbh|elterninitiative|betreut\.de"),

...
STAEDTE = [
    ...
    'Erbach',
    'Pfedelbach',
    # D-139 (14.09.2026, Justin: "mehr Hebammen, ausserhalb Deutschland"): Oesterreich (Wien nach Bezirken),
    # deutschsprachige Schweiz, Suedtirol, Liechtenstein - Indizes ab 1114
    'Wien Innere Stadt',
    'Wien Leopoldstadt',
    'Wien Landstraße',
    'Wien Wieden',

...
BEGRIFFE = {
    ...
    'fotobox': 'Fotobox mieten Photobooth Hochzeit',
    'zauberer': 'Zauberer Magier buchen Kinderzauberer',
    'eventmoderator': 'Eventmoderator Moderatorin buchen',
    'lichttechniker': 'Veranstaltungstechnik Lichttechnik Einzelunternehmer',
    'messebauer': 'Messebauer Messestandbau Einzelunternehmen',
    'textildruck': 'Textildruck Stickerei Siebdruck Einzelunternehmen',
    'steinmetz': 'Steinmetz Grabmale Steinbildhauer',
    'autolackierer': 'Lackiererei Karosseriebau Einzelunternehmen',
    'rohrreinigung': 'Rohrreinigung Kanalreinigung Einzelunternehmer',
    'klimatechniker': 'Klimatechnik Kältetechnik Einzelunternehmen',
    'rollladenbauer': 'Rollladenbau Markisen Sonnenschutz Einzelunternehmen',
    'zaunbauer': 'Zaunbau Zaunbauer Einzelunternehmen',
    'poolbauer': 'Poolbau Schwimmteich Saunabau Einzelunternehmen',
    'winterdienst': 'Winterdienst Grünpflege Hausmeister Einzelunternehmen',
    'abschleppdienst': 'Abschleppdienst Pannenhilfe Einzelunternehmer',
    'taxiunternehmer': 'Taxiunternehmen Einzelunternehmer Mietwagen Krankenfahrten',
    'wassersportlehrer': 'Segelschule Surfschule Kiteschule SUP Einzelunternehmer',
    'skilehrer': 'Skilehrer Skischule privat Snowboardlehrer',
    'sprecher': 'Sprecher Synchronsprecher Voice-over Freelancer',
    'lektor': 'Lektorat Korrektorat freiberuflich',
    'sattler': 'Sattlerei Sattler Autosattler Einzelunternehmen',
    'achtsamkeitstrainer': 'Achtsamkeitstrainer Meditationslehrer MBSR',
    'rhetoriktrainer': 'Rhetoriktrainer Kommunikationstrainer freiberuflich',
    'kartenleger': 'Kartenlegerin Tarot Lebensberatung',
...
STAEDTE = [
    ...
    # Welle 28 (13.09.2026): Kleinstädte 15.000–50.000 Einwohner für die Städte-Blöcke ab maps_ab=300
    "Ahaus", "Ahrensburg", "Alsdorf", "Altenburg", "Alzey", "Apolda",
    "Arnstadt", "Aschersleben", "Attendorn", "Aurich", "Bad Aibling", "Bad Berleburg",
    "Bad Driburg", "Bad Dürkheim", "Bad Harzburg", "Bad Honnef", "Bad Nauheim", "Bad Neuenahr-Ahrweiler",
    "Bad Pyrmont", "Bad Säckingen", "Bad Schwartau", "Bad Segeberg", "Bad Soden", "Bad Tölz",
    "Bad Vilbel", "Bad Waldsee", "Bad Wildungen", "Bad Zwischenahn", "Baesweiler", "Baunatal",
    "Bebra", "Beckum", "Bensheim", "Bergkamen", "Bernburg", "Biberach an der Riß",
    "Bingen am Rhein", "Bitburg", "Bitterfeld-Wolfen", "Blankenburg", "Blieskastel", "Borken",
    "Bornheim", "Brühl", "Buchholz in der Nordheide", "Buxtehude", "Burgdorf", "Burghausen",
    "Butzbach", "Coesfeld", "Cloppenburg", "Crimmitschau", "Datteln", "Delitzsch",
    "Dieburg", "Diepholz", "Dillenburg", "Dingolfing", "Ditzingen", "Döbeln",
    "Dülmen", "Ebersberg", "Ehingen", "Eisenhüttenstadt", "Eislingen", "Ellwangen",
    "Elsdorf", "Emmendingen", "Emmerich am Rhein", "Emsdetten", "Erftstadt", "Erkelenz",
    "Erkrath", "Eschborn", "Eschweiler", "Espelkamp", "Eutin", "Filderstadt",
    "Finsterwalde", "Forst", "Frankenberg", "Frechen", "Freital", "Friedberg",
    "Friedrichsdorf", "Fürstenwalde", "Gaggenau", "Garbsen", "Geesthacht", "Geilenkirchen",
    "Geldern", "Gelnhausen", "Georgsmarienhütte", "Germering", "Germersheim", "Gevelsberg",
    "Gifhorn", "Goch", "Greven", "Griesheim", "Gronau", "Groß-Gerau",
    "Gunzenhausen", "Haan", "Hagenow", "Haltern am See", "Hann. Münden", "Haßloch",
    "Hattingen", "Heide", "Heidenau", "Heiligenhaus", "Hemer", "Hennef",
    "Hennigsdorf", "Herzogenrath", "Hilden", "Hockenheim", "Hohen Neuendorf", "Holzminden",
    "Höxter", "Hoyerswerda", "Hückelhoven", "Ibbenbüren", "Idar-Oberstein", "Idstein",
    "Ilmenau", "Ingelheim am Rhein", "Isernhagen", "Jülich", "Kamen", "Kamp-Lintfort",
    "Karben", "Kaarst", "Kehl", "Kelkheim", "Kevelaer", "Kirchheim bei München",
    "Königs Wusterhausen", "Königswinter", "Korbach", "Korschenbroich", "Kreuztal", "Laatzen",
    "Lage", "Lahr", "Lampertheim", "Langen", "Langenfeld", "Langenhagen",
    "Lauf an der Pegnitz", "Leer", "Lehrte", "Leinfelden-Echterdingen", "Lemgo", "Lengerich",
    "Limbach-Oberfrohna", "Lindlar", "Lohmar", "Lübbecke", "Lüdinghausen", "Luckenwalde",
    "Ludwigsfelde", "Maintal", "Marktoberdorf", "Meckenheim", "Meerbusch", "Meinerzhagen",
    "Melle", "Menden", "Meppen", "Merseburg", "Mettmann", "Monheim am Rhein",
    "Mörfelden-Walldorf", "Mühlhausen", "Mühldorf am Inn", "Naumburg", "Netphen", "Nettetal",
    "Neu-Isenburg", "Neukirchen-Vluyn", "Neuruppin", "Neustadt am Rübenberge", "Neustadt in Holstein", "Nienburg",
    "Nordenham", "Northeim", "Oberursel", "Oer-Erkenschwick", "Oberkirch", "Olching",
    "Olpe", "Osterholz-Scharmbeck", "Ostfildern", "Overath", "Papenburg", "Peine",
    "Pfaffenhofen an der Ilm", "Pulheim", "Quedlinburg", "Radebeul", "Radolfzell", "Rathenow",
    "Ratzeburg", "Rendsburg", "Rheda-Wiedenbrück", "Rheinbach", "Rheinberg", "Rheinfelden",
    "Riedstadt", "Rietberg", "Rinteln", "Rödermark", "Rodgau", "Rösrath",
    "Rotenburg (Wümme)", "Rottenburg am Neckar", "Rudolstadt", "Saalfeld", "Salzkotten", "Sangerhausen",
    "Sankt Augustin", "Sankt Ingbert", "Schmallenberg", "Schönebeck", "Schwedt", "Schwelm",
    "Schwerte", "Seelze", "Seevetal", "Selm", "Senden", "Senftenberg",
    "Sömmerda", "Sondershausen", "Sonneberg", "Sonthofen", "Springe", "Stadtallendorf",
    "Stadthagen", "Steinfurt", "Stolberg", "Straelen", "Strausberg", "Stuhr",
    "Sundern", "Taunusstein", "Teltow", "Tönisvorst", "Torgau", "Traunreut",
    "Uelzen", "Unterhaching", "Unterschleißheim", "Vaihingen an der Enz", "Varel", "Vechta",
    "Verden", "Voerde", "Waldkraiburg", "Waldshut-Tiengen", "Walsrode", "Wangen im Allgäu",
    "Warendorf", "Wedel", "Wegberg", "Weil am Rhein", "Weilheim in Oberbayern", "Weinstadt",
    "Weißenburg in Bayern", "Weißenfels", "Werl", "Wermelskirchen", "Wernigerode", "Wesseling",
    "Wetter (Ruhr)", "Wiehl", "Willich", "Winnenden", "Winsen (Luhe)", "Wittlich",
    "Wittmund", "Wülfrath", "Wunstorf", "Würselen", "Xanten", "Zeitz",
    "Zerbst", "Zweibrücken", "Achim", "Aichach", "Alfeld", "Altötting",
    "Annaberg-Buchholz", "Aue-Bad Schlema", "Bad Bramstedt", "Bad Iburg", "Bad Laasphe", "Bad Lippspringe",
    "Bad Oldesloe", "Bad Saulgau", "Bad Urach", "Bad Wörishofen", "Balve", "Barsinghausen",
    "Bruchköbel", "Brunsbüttel", "Bückeburg", "Burg", "Cham", "Clausthal-Zellerfeld",
    "Eilenburg", "Einbeck", "Ennepetal", "Freilassing", "Freudenberg", "Friesoythe",
    "Fröndenberg", "Gardelegen", "Geretsried", "Gersthofen", "Grevesmühlen", "Groß-Umstadt",
    "Haar", "Halstenbek", "Hamminkeln", "Harsewinkel", "Heppenheim", "Herzberg am Harz",
    "Hettstedt", "Hilchenbach", "Hofheim am Taunus", "Holzwickede", "Höhr-Grenzhausen", "Hörstel",
    "Ilsede", "Jever", "Kaltenkirchen", "Kaufungen", "Kirchhain", "Königsbrunn",
    "Kronberg im Taunus", "Landau an der Isar", "Lauterbach", "Lehre", "Leichlingen", "Lengede",
    "Lohne", "Mayen", "Meschede", "Moosburg an der Isar", "Much", "Neunkirchen-Seelscheid",
    "Niederkassel", "Oelde", "Oschatz", "Ottobrunn", "Penzberg", "Pfungstadt",
    "Plettenberg", "Puchheim", "Quakenbrück", "Radevormwald", "Regen", "Reinbek",
    "Rosbach vor der Höhe", "Schifferstadt", "Schongau", "Schrobenhausen", "Schwandorf", "Seligenstadt",
    "Simmern", "Sinzig", "Soltau", "Steinhagen", "Sulzbach-Rosenberg", "Tostedt",
    "Trossingen", "Uetersen", "Vallendar", "Vreden", "Wachtberg", "Waldbröl",
    "Waltrop", "Warstein", "Wedemark", "Weiterstadt", "Werne", "Wildeshausen",
    "Wipperfürth", "Wolfratshausen", "Zirndorf",
    # Welle 29 (13.09.2026, 23:00): Großstadt-Stadtteile (Hebammen/Tagesmütter sind in Großstädten dicht,
    # gosom -depth 1 zeigt je Abfrage nur die erste Seite) — Indizes ab 687
    'Berlin Mitte',
    ...
    # Welle 29: weitere Kleinstädte, die in fabrik2_firmen als Ort vorkommen, aber nie abgefragt wurden — Indizes ab 877
    'Wittenberg',
    'Dessau',
    'Aßlar',
    'Stutensee',
